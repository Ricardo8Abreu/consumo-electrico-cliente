...
const FormCalcularConsumo = ({  }) => {
    ...
    return (
        <form className="flex p-6 font-bold flex-col sm:flex-row  gap-7 items-center justify-center"
            onSubmit={handleCalcularConsumo}
            
        >
            <div className="flex gap-7 w-[400px] justify-center items-center grow">
                <FormInputs
                    data={dataFormInput}
                />
            </div>
